...
// 定義要執行的檔案路徑（相對路徑）
const scripts = [
  path.join(__dirname, 'week_newStore_Changed.js'),
  path.join(__dirname, 'showChangedNameStore.js'),
  path.join(__dirname, 'DifferentJsonShowAndToFile.js'),
  path.join(__dirname, 'weekNewStoreList.js')
];
