...
async def create_clients(ws_url: str, num_clients: int) -> List[WebSocketClient]:
    ...
    # client_id = 'a010m'     # OK
    # client_id = 'a010n'     # OK
    # client_id = 'a010p'     # Fail
    # client_id = 'a010q'     # Fail
    # client_id = 'a010r'     # OK
    # client_id = 'a010s'     # OK
    # client_id = 'a010t'     # OK
    # client_id = 'a010v'     # OK
    client_id = 'a010w'     # OK
    # client_id = 'a010x'     # Fail
    # client_id = 'a010y'     # Fail
    # client_id = 'a010z'     # OK

    # client_id = 'a011w'     # OK
    # client_id = 'a011x'     # Fail
    # client_id = 'a011y'     # Fail
...
async def main():
    ...
    # 選擇伺服器
    target_env = ws_urls["local"]
    target_env = ws_urls["trial"]
    target_env = ws_urls["live"]
