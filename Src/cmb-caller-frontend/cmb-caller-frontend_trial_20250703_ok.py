...
2025/06/05  Roy Ching    加入login(auth) json 執行
2025/06/05  Roy Ching    加入get_num_info json  執行
...
2025/06/20  Roy Ching    傳入 Maim Server 的資料皆加入 Retrt 3次 功能.
...
class WebSocketServer:
    ...
    async def handler(self, websocket, path):       # Caller
        ...
        try:
            ...
            caller_type = clients[caller_id]['connections'][websocket]
            logging.warning(
