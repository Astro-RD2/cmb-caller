...
def get_platform_config():
    ...
    if os_name == 'Windows':
        # return 38000, "ws://localhost:8088", 'Windows'      # Local WIndows PC
        # return 38000, "wss://callnum-receiver-306511771181.asia-east1.run.app/", 'Windows'  # CMB Trying
        return 38000, "wss://callnum-receiver-410240967190.asia-east1.run.app/", 'Windows'  # CMB Live
        # return 38000, "ws://35.185.131.62:4000", 'Windows'  # Jando VM
        # return 38000, "wss://cmb-front-end.callmeback.com.tw/", 'Windows'  # CMB Trying
        # return 38000, "ws://cmb-front-end.callmeback.com.tw:4000", 'Windows'  # 勿用,測試轉址已關閉
        # return 38000, "ws://cmb-front-end.callmeback.com.tw:8765", 'Windows'  # 勿用,測試轉址至 cmb-caller-frontend.py
